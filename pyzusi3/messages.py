...
# Zusi -> Client
#
class DATAOPS_TASTATURZUORDNUNG(Enum):
    KEINE = auto()
    FAHRSCHALTER = auto()
    DYNAMISCHE_BREMSE = auto()
    AFB_TEMPOMAT = auto()
    FUEHRERBREMSVENTIL = auto()
    ZUSATZBREMSVENTIL = auto()
    GANG = auto()
    RICHTUNGSSCHALTER = auto()
    STUFENSCHALTER = auto()
    SANDER = auto()
    TUEREN = auto()
    LICHT = auto()
    ...
    GLOCKE = auto()
    LUEFTER = auto()
    ZUGBEEINFLUSSUNG = auto()
    SIFA = auto()
    HAUPTSCHALTER = auto()
    GRUPPENSCHALTER = auto()
    SCHLEUDERSCHUTZ = auto()
    MG_BREMSE = auto()
    LOKBREMSE_ENTLUEFTEN = auto()
    FAHRPULTINTERN_01 = auto()
    FAHRPULTINTERN_02 = auto()
    FAHRPULTINTERN_03 = auto()
    FAHRPULTINTERN_04 = auto()
    FAHRPULTINTERN_05 = auto()
    FAHRPULTINTERN_06 = auto()
    FAHRPULTINTERN_07 = auto()
    FAHRPULTINTERN_08 = auto()
    FAHRPULTINTERN_09 = auto()
    FAHRPULTINTERN_10 = auto()
    FAHRPULTINTERN_11 = auto()
    FAHRPULTINTERN_12 = auto()
    FAHRPULTINTERN_13 = auto()
    FAHRPULTINTERN_14 = auto()
    FAHRPULTINTERN_15 = auto()
    FAHRPULTINTERN_16 = auto()
    FAHRPULTINTERN_17 = auto()
    FAHRPULTINTERN_18 = auto()
    FAHRPULTINTERN_19 = auto()
    FAHRPULTINTERN_20 = auto()
    PROGRAMMSTEUERNG = auto()
    STROMABNEHMER = auto()
    FUEHRERSTANDSSICHT = auto()
    LUFTPRESSER_AUS = auto()
    ZUGFUNK = auto()
    LZB = auto()
    FAHRPULTINTERN_21 = auto()
    FAHRPULTINTERN_22 = auto()
    FAHRPULTINTERN_23 = auto()
    FAHRPULTINTERN_24 = auto()
    FAHRPULTINTERN_25 = auto()
    FAHRPULTINTERN_26 = auto()
    FAHRPULTINTERN_27 = auto()
    FAHRPULTINTERN_28 = auto()
    FAHRPULTINTERN_29 = auto()
    FAHRPULTINTERN_30 = auto()
    FAHRPULTINTERN_31 = auto()
    FAHRPULTINTERN_32 = auto()
    FAHRPULTINTERN_33 = auto()
    FAHRPULTINTERN_34 = auto()
    FAHRPULTINTERN_35 = auto()
    FAHRPULTINTERN_36 = auto()
    FAHRPULTINTERN_37 = auto()
    FAHRPULTINTERN_38 = auto()
    FAHRPULTINTERN_39 = auto()
    FAHRPULTINTERN_40 = auto()
    NOTAUS = auto()
    FEDERSPEICHERBREMSE = auto()
    BATTERIEHAUPTSCHALTER_AUS = auto()
    NOTBREMSUEBERBRUECKUNG = auto()
    BREMSPROBEFUNKTION = auto()
    LEISTUNG_AUS = auto()
    FAHRZEUGINTERN_01 = auto()
    FAHRZEUGINTERN_02 = auto()
    FAHRZEUGINTERN_03 = auto()
    FAHRZEUGINTERN_04 = auto()
    FAHRZEUGINTERN_05 = auto()
    FAHRZEUGINTERN_06 = auto()
    FAHRZEUGINTERN_07 = auto()
    FAHRZEUGINTERN_08 = auto()
    FAHRZEUGINTERN_09 = auto()
    FAHRZEUGINTERN_10 = auto()
    FAHRZEUGINTERN_11 = auto()
    FAHRZEUGINTERN_12 = auto()
    FAHRZEUGINTERN_13 = auto()
    FAHRZEUGINTERN_14 = auto()
    FAHRZEUGINTERN_15 = auto()
    FAHRZEUGINTERN_16 = auto()
    FAHRZEUGINTERN_17 = auto()
    FAHRZEUGINTERN_18 = auto()
    FAHRZEUGINTERN_19 = auto()
    FAHRZEUGINTERN_20 = auto()
    FUEHRERTISCH_DEAKTIVIEREN = auto()
class DATAOPS_TASTATURKOMMANDO(Enum):
    """Aus Doku übernommen"""
    Unbestimmt = auto()
    FahrschalterAuf_Down = auto()
    FahrschalterAuf_Up = auto()
    FahrschalterAb_Down = auto()
    FahrschalterAb_Up = auto()
    FahrschalterGrundstellung = auto()
    FahrschalterEinAus_Down = auto()
    FahrschalterEinAus_Up = auto()
    DynBremseAuf_Down = auto()
    DynBremseAuf_Up = auto()
    DynBremseAb_Down = auto()
    DynBremseAb_Up = auto()
    DynBremseGrundstellung = auto()
    DynBremseEinAus_Down = auto()
    DynBremseEinAus_Up = auto()
    AFBAuf_Down = auto()
    AFBAuf_Up = auto()
    AFBAb_Down = auto()
    AFBAb_Up = auto()
    AFBGrundstellung = auto()
    AFBEinAus_Down = auto()
    AFBEinAus_Up = auto()
    GangAuf_Down = auto()
    GangAuf_Up = auto()
    GangAb_Down = auto()
    GangAb_Up = auto()
    GangGrundstellung = auto()
    FbvAuf_Down = auto()
    FbvAuf_Up = auto()
    FbvAb_Down = auto()
    FbvAb_Up = auto()
    Angleicher_Down = auto()
    Angleicher_Up = auto()
    ZbvAuf_Down = auto()
    ZbvAuf_Up = auto()
    ZbvAb_Down = auto()
    ...
    RischaAb_Down = auto()
    RischaAb_Up = auto()
    StufenschalterAuf_Down = auto()
    StufenschalterAuf_up = auto()
    StufenschalterAb_Down = auto()
    StufenschalterAb_Up = auto()
    Sand_Down = auto()
    Sand_Up = auto()
    Schleuderschutz_Down = auto()
    Schleuderschutz_Up = auto()
    PZBWachsam_Down = auto()
    PZBWachsam_Up = auto()
    PZBFrei_Down = auto()
    PZBFrei_Up = auto()
    PZBBefehl_Down = auto()
    ...
    Sifa_Down = auto()
    Sifa_Up = auto()
    TuerenTaster_Down = auto()
    TuerenTaster_Up = auto()
    TuerenLi_Down = auto()
    TuerenLi_Up = auto()
    TuerenRe_Down = auto()
    TuerenRe_Up = auto()
    ...
    MotorAb_Down = auto()
    MotorAb_Up = auto()
    HauptschalterEin_Down = auto()
    HauptschalterEin_Up = auto()
    HauptschalterAus_Down = auto()
    HauptschalterAus_Up = auto()
    SAAuf_Down = auto()
    SAAuf_Up = auto()
    SAAb_Down = auto()
    SAAb_Up = auto()
    ...
    Fst4_Down = auto()
    Fst4_Up = auto()
    LuftpresserAus_Down = auto()
    LuftpresserAus_Up = auto()
    FunkGabel_Down = auto()
    FunkGabel_Up = auto()
    FunkSprechknopf_Down = auto()
    FunkSprechknopf_Up = auto()
    LZB_G_Down = auto()
    LZB_G_Up = auto()
    LZB_Stoer_Down = auto()
    LZB_Stoer_Up = auto()
    LZB_Nothalt_Down = auto()
    LZB_Nothalt_Up = auto()
    Nothalt_Down = auto()
    Nothalt_Up = auto()
    FederspeicherAuf_Down = auto()
    FederspeicherAuf_Up = auto()
    FederspeicherAb_Down = auto()
    FederspeicherAb_Up = auto()
    BatterieHSAusAuf_Down = auto()
    BatterieHSAusAuf_Up = auto()
    BatterieHSAusAb_Down = auto()
    BatterieHSAusAb_Up = auto()
    NBUeAus_Down = auto()
    NBUeAus_Up = auto()
    NBUeQuittierung_Down = auto()
    NBUeQuittierung_Up = auto()
    NBUeTest_Down = auto()
    NBUeTest_Up = auto()
    Bremsprobe_Down = auto()
    Bremsprobe_Up = auto()
    LeistungAus_Down = auto()
    LeistungAus_Up = auto()
    ETCSQuittieren_Down = auto()
    ETCSQuittieren_Up = auto()
    TischAuf_Down = auto()
    TischAuf_Up = auto()
    TischAus_Down = auto()
    TischAus_Up = auto()
    SifaPruefmodus_Down = auto()
    SifaPruefmodus_Up = auto()
    SifaFusspedal_Down = auto()
    SifaFusspedal_Up = auto()
class DATAOPS_TASTATURAKTION(Enum):
    Default = auto()
    Down = auto()
    Up = auto()
    Auf_Down = auto()
    ...
    Absolut = auto()
    Absolut1000er = auto()
class DATAOPS_SCHALTERFUNKTION(Enum):
    NICHTS = auto()
    FAHRSTUFE = auto()
    FAHRSTUFE_SCHNELLAUS = auto()
    FAHRSTUFE_AUFSCHALTEN = auto()
    FAHRSTUFE_KONSTANT = auto()
    FAHRSTUFE_ABSCHALTEN = auto()
    DYN_BREMSE_STUFE = auto()
    DYN_BREMSE_0 = auto()
    DYN_BREMSE_AUFSCHALTEN = auto()
    DYN_BREMSE_KONSTANT = auto()
    DYN_BREMSE_ABSCHALTEN = auto()
    AFB = auto()
    AFB_0 = auto()
    AFB_AUF = auto()
    AFB_AB = auto()
    AFB_EIN_AUS = auto()
    ZUGKRAFT_ABSOLUT = auto()
    ZUGKRAFT_SCHNELLAUS = auto()
    ZUGKRAFT_AUFSCHALTEN = auto()
    ZUGKRAFT_KONSTANT = auto()
    ZUGKRAFT_ABSCHALTEN = auto()
    HLL_FUELLEN = auto()
    HLL_FESTE_STUFE = auto()
    HLL_ABSCHLUSS = auto()
    HLL_MITTEL = auto()
    HLL_SCHNELLBREMSUNG = auto()
    ANGLEICHER = auto()
    ZBV_LOESEN = auto()
    ZBV_MITTEL = auto()
    ZBV_BREMSEN = auto()
    ...
    GANGWAHL_0 = auto()
    GANGWAHL_AUF = auto()
    GANGWAHL_FAHREN = auto()
    GANGWAHL_AB = auto()
    RICHTUNGSSCHALTER_V = auto()
    RICHTUNGSSCHALTER_M = auto()
    RICHTUNGSSCHALTER_0 = auto()
    RICHTUNGSSCHALTER_R = auto()
    STUFENSCHALTER_LG = auto()
    STUFENSCHALTER_0 = auto()
    STUFENSCHALTER_SG = auto()
    GRUPPENSCHALTER_STOP = auto()
    GRUPPENSCHALTER_AUS = auto()
    GRUPPENSCHALTER_EIN = auto()
    GRUPPENSCHALTER_START = auto()
    STROMABNEHMER_AB = auto()
    STROMABNEHMER_MITTE = auto()
    STROMABNEHMER_AUF = auto()
    HAUPTSCHALTER_AUS = auto()
    HAUPTSCHALTER_MITTE = auto()
    HAUPTSCHALTER_EIN = auto()
    MG_BREMSE = auto()
    SANDEN = auto()
    UNBENUTZT_01 = auto()
    UNBENUTZT_02 = auto()
    ...
    FAHRPULTINTERN_39 = auto()
    FAHRPULTINTERN_40 = auto()
    FEDERSPEICHER_ANLEGEN = auto()
    FEDERSPEICHER_MITTE = auto()
    FEDERSPEICHER_LOESEN = auto()
    FEDERSPEICHER_UMSCHALTEN = auto()
    BATTERIEHAUPTSCHALTER_AUS = auto()
    BATTERIEHAUPTSCHALTER_MITTE = auto()
    BATTERIEHAUPTSCHALTER_EIN = auto()
    FAHRSCHALTER_DEAKTIVIEREN = auto()
    DYNAMISCHE_BREMSE_DEAKTIVIEREN = auto()
    COMPUTERBREMSE_BREMSKRAFT = auto()
    COMPUTERBREMSE_AUFSCHALTEN = auto()
    COMPUTERBREMSE_KONSTANT = auto()
    COMPUTERBREMSE_ABSCHALTEN = auto()
    FAHRZEUGINTERN_01 = auto()
    FAHRZEUGINTERN_02 = auto()
    FAHRZEUGINTERN_03 = auto()
    FAHRZEUGINTERN_04 = auto()
...
llps[DATA_OPERATION] = (
    ...
    LLP(PID(2, 0x0b, 1, 3), 'aktion', ContentType.WORD, DATAOPS_TASTATURKOMMANDO),
