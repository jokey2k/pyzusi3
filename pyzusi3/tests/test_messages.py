...
class TestInstantiation(unittest.TestCase):
    def test_all_messages(self):
        ...
        messages.STATUS_ZUGVERBAND_FAHRZEUG()
        messages.STATUS_ZUGVERBAND_ZUGBEEINFLUSSUNGSSYSTEME()
        messages.STATUS_ZUGVERBAND_TUERSCHLIESSSYSTEM()
        messages.STATUS_ZUGVERBAND_BREMSSTELLUNG()
        messages.STATUS_ZUGVERBAND_ANTRIEBSSYSTEM()
        messages.STATUS_ZUGVERBAND_BREMSSYSTEM()
